        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          {warningDetails && (
            <div className="mt-4 pt-4 border-t border-gray-200">
              <h4 className="text-sm font-medium text-gray-700 mb-2">詳細信息</h4>
              ...
              {warningDetails.text_render_failed?.length > 0 && (
                <div className="mb-3">
                  <p className="text-xs text-gray-500 mb-1">
                    文本渲染失敗 ({warningDetails.text_render_failed.length} 個)
                  </p>
                  <div className="text-xs text-gray-600 bg-gray-50 p-2 rounded max-h-32 overflow-y-auto">
